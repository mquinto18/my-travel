...
const TopRate = () => {
  ...
  return (
    <div
      id="reviews"
      className="max-w-[1000px] h-[450px] lg:h-[280px] m-auto mt-20 "
    >
      <div className="lg:flex justify-between gap-20">
        <div className=" lg:flex flex-col">
          ...
          <div>
            <button
              onClick={handleClick}
              className="ml-16 border border-black px-8 py-1 mt-3 rounded-[20px]"
            >
              <i className="fa-solid fa-arrow-right text-[25px]"></i>
            </button>
          </div>
        </div>
